...
import com.example.bookfood.R.string;
...
public class logonActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String logon=getResources().getString(R.string.logon);
		String b=String.format(logon,"inazuma");
		findView();
		setView();
	}
			...
			public void onClick(View v) {
				...
				if ("".equals(username_edit.getText().toString().trim()))
					...
					if (testify()) {
						...
						String logon=getResources().getString(R.string.logon);
						logon=String.format(logon,"inazuma");
